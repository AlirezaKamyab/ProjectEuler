...
//Answer to problem projecteuler.net/problem=67
#include <iostream>
#include <string>
#include <fstream>
using namespace std;
...
void makeArray(int** numbers, const string fileName = "MaximumPathSumII.txt");
void addRow(int** numbers, const int n, const string value);
int convertToNumber(const string value);
int countRows(const string fileName = "MaximumPathSumII.txt");
